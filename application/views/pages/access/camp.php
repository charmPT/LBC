<html>
<title> LBC User Account User Guide </title>
<head>
...
<body>
	...
	<div class = "container">
		<div class = "page-header">
				<h1> <b><span class="list-group-item header-bg" > LBC User Account User Guide </span></b> </h1>
		</div>
	</div>
	      							...
	      							<div class="panel-body">
	        							<ul> 
							        		<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#SMSTraffic"> SMS Traffic Report </a> </li>
							        			<ul>
							        				<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#GenerateReport"> Sample SMS Traffic Report </a> </li>
												</ul>
										</ul>
									</div>
								</div>
	...
	<div class="col-sm-9">
											...
											<table class="table table-bordered table-striped">
										        ...
										        <tbody>
										            ...
										            <tr>
										                ...
										                <td class="col-sm-5"> <b> Required. </b> List of Products used for SMS blast </td>
										            </tr>

										            <tr>
										                <td class="col-sm-1">Campaign Name</td>
										                <td class="col-sm-5"> <b> Required. </b> Name of the SMS campaign </td>
										            </tr>
										        ...
										        <tbody>
										           <tr>
										            ...
										            <tr>
										                ...
										                <td class="col-sm-5"><p> SMS blast creator's name </p> </td>
										            </tr>
				               	...
				               	<div class="thumbnail">
			                  		<div class="caption">
				                    	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/sentcampaign.png" style="width:90%;"> </center> <br>
										 	<p> List campaigns that were successfully processed. </p>
										 	<table class="table table-bordered table-striped">
			                					<thead>
										            <tr>
										                <th class="col-sm-2"><span>Column</span></th> 
		...
		<h1 id="Phonebook"> <strong> Phonebook </strong> </h1>     
			...
			<h4 id="AddContacts"> <strong> Add Contact </strong> </h4>
			<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>
				<div class= "col-sm-112">
					<div class="row-fluid">
			            <div class="thumbnails">
										 	...
										 	<table class="table table-bordered table-striped">
										        ...
										        <tbody>
										            ...
										            <tr>
										                ...
										                <td class="col-sm-5"> Date and Time the contacts file was uploaded </td>
										            </tr>
