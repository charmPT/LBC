...
<body>
	...
	<div class = "container">
		<div class = "page-header">
				<h1> <b><span class="list-group-item header-bg" > LBC Superadmin User Guide </span></b> </h1>
		</div>
	</div>
			...
			<div class="col-sm-3">
				<div class="list-group">
					<div class="panel-group" id="accordion">
								...
								<div id="collapseThree" class="panel-collapse collapse">
	      							<div class="panel-body">
	        							<ul> 
							        		...
							        		<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#Blockedlist"> Blocked list </a> </li>
											...
											<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#Cleanups"> Cleanups </a> </li>
										</ul>
									</div>
								</div>
						</div>
						...
						<div class="panel panel-default">
	    					<div class="panel-heading">
	    						<a data-toggle="collapse" data-parent="#accordion" href="#collapseEight"> <b> SEARCH </b> </a>
	      					</div>
								<div id="collapseEight" class="panel-collapse collapse">
	      							<div class="panel-body">
	        							<ul> 
	        								<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#MobileSearch"> Mobile Search </a> </li>
	        								<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#InboundLogs"> Inbound Logs </a> </li>
							        		<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#HlrSearch"> HLR Search </a> </li>
										</ul>
									</div>
								</div>
						</div>		
								...
								<div id="collapseSeven" class="panel-collapse collapse">
	      							<div class="panel-body">
	        							<ul> 
							        		...
							        		<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#Departments"> Departments </a> </li>
							        		<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#DepartmentUsers"> Department Users </a> </li>	
							        			<ul>
													<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#ManageUsers"> Manage Users </a> </li>	
													<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#DepartmentAddUsers"> Add New User </a> </li>	
												</ul>
							        		<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#Products"> Products </a> </li>
							        		<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#Keywords"> Keywords</a> </li>
							        		<li> <a href="<?php echo site_url("sample/page_campaign"); ?>#CustomFields"> Custom Fields </a> </li>
	...
	<div class="col-sm-9">
		...
		<h4 id="AddContacts"> <strong> Add Contacts </strong> </h4>
			...
			<h4 id="Blockedlist"> <strong> Blocked List </strong> </h2>
				<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/blockedlist.png"  style="width:100%;"><br>
	                	   	   	<div class="caption">
			                    	<!-- <p> Displays campaign name, filters and delivery status. </p> -->
			                    		<p> sdfsvs </p> <br> 
			...
			<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>
				...
				<h4 id="Cleanups"> <strong> Cleanups </strong> </h2>
				<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/cleanups.png"  style="width:100%;"><br>
	                	   	   	<div class="caption">
			                    	<!-- <p> Displays campaign name, filters and delivery status. </p> -->
			                    		<p> Page to view all contacts saved in the account. </p> <br> 
					              			...
					              			<table class="table table-bordered table-striped">
										        ...
										        <tbody>
										            ...
										            <tr>
										                <td class="col-sm-1">Clean Up Name </td>
										                <td class="col-sm-5">  </td>
										            </tr>
			...
			<h1 id="Search"> <strong> Search </strong> </h1>     
		   	<h4 id="MobileSearch"> <strong> Mobile Search </strong> </h2>
				<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/mobilesearch.png"  style="width:95%;"> </center><br>
	                	   	<ol>
		                		<li> Fill out Mobile Number  </li>
		                		<li> Click Search  </li>
		                	</ol>
		                		<div class="caption">
			                    	<table class="table table-bordered table-striped">
			...
			<h4 id="InboundLogs"> <strong> Inbound Logs </strong> </h2>
				<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/inboundlogs.png"  style="width:95%;"> </center><br>
	                	   	<p> hsguiabsciu </p>
		                		<div class="caption">
			                    	<table class="table table-bordered table-striped">
										<thead>
								        ...
								        <tbody>
								            ...
								            <tr>
								                <td class="col-sm-1">Sender </td>
								                <td class="col-sm-5">   </td>
								            </tr>

								            <tr>
								                <td class="col-sm-1">Receiver</td>
								                <td class="col-sm-5">   </td>
								            </tr>
									...
									<table class="table table-bordered table-striped">
								        ...
								        <tbody>
								            <tr>
								                <td class="col-sm-1">Select Keyword</td>
								                <td class="col-sm-5">  </td>
								            </tr>
			...
			<h4 id="HlrSearch"> <strong> HLR Search </strong> </h2>
				<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/hlr.png"  style="width:95%;"> </center><br>
	                	   	<ol>
	                	   		<li> Fill out Mobile Number </li>
	                	   		<li> Click Search </li>
	                	   	</ol>
		                		<div class="caption">
			                    	...
			                    	<table class="table table-bordered table-striped">
								        ...
								        <tbody>
								            ...
								            <tr>
								                <td class="col-sm-1">Ported From</td>
								                <td class="col-sm-5">   </td>
								            </tr>
								        </tbody>
									</table>
		                	...
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/standardlogsreport.png"  style="width:100%;"> </center><br>
	                	   		...
	                	   		<div class="caption">
			                    	<table class="table table-bordered table-striped">
								        ...
								        <tbody>
								            <tr>
								                <td class="col-sm-1">Date Range </td>
								                <td class="col-sm-5">  </td>
								            </tr>
								        </tbody>
									</table>
			                    	...
			                    	<table class="table table-bordered table-striped">
								        ...
								        <tbody>
								            ...
								            <tr>
								             ...
								             <tr>
								                <td class="col-sm-1"> Tracking Number </td>
								                <td class="col-sm-5">  </td>
								            </tr>

								            <tr>
								                <td class="col-sm-1"> LBC Track & Trace status </td>
								                <td class="col-sm-5">  </td>
								            </tr>

								            <tr>
								                <td class="col-sm-1"> LBC Load Number</td>
								                <td class="col-sm-5">  </td>
								            </tr>
								            ...
								            <tr>
								                <td class="col-sm-1"> SMS Message </td>
								                <td class="col-sm-5"> </td>
								            </tr>
			...
			<h4 id="GenerateReport"> <strong> Custom Report (SMS Monthly Reports - Phonebook) </strong> </h2>
				<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/monthlyphonebook.png"  style="width:50%;"> </center><br>
	                	   		<ol> 
	                	   		...
	                	   		<div class="caption">
			                    	<table class="table table-bordered table-striped">
										        ...
										        <tbody>
										            ...
										            <tr>
										                <td class="col-sm-1">Break down by</td>
										                <td class="col-sm-5">  </td>
										            </tr>
										        </tbody>
											</table>
											...
											<table class="table table-bordered table-striped">
												...
												<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/monthlyphonebook1.png"  style="width:100%;"> </center>
												<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/monthlyphonebook2.png"  style="width:100%;"> </center><br>
													<table class="table table-bordered table-striped">
														<thead>
												            <tr>
												                <th class="col-sm-2"><span>Column</span></th> 
												        ...
												        <tbody>
												            ...
												            <tr>
												                <td class="col-sm-1"> MTD </td>
												                <td class="col-sm-5">  </td>
												            </tr>

												            <tr>
												                <td class="col-sm-1"> YTD </td>
												                <td class="col-sm-5">  </td>
												            </tr>

												            <tr>
												                <td class="col-sm-1"> CTD </td>
												                <td class="col-sm-5">  </td>
												            </tr>

												            <tr>
												                <td class="col-sm-1"> Last Year </td>
												                <td class="col-sm-5">  </td>
												            </tr>

												            <tr>
												                <td class="col-sm-1"> MoM Growth </td>
												                <td class="col-sm-5">  </td>
												            </tr>

												            <tr>
												                <td class="col-sm-1">YoY Growth </td>
												                <td class="col-sm-5">  </td>
												            </tr>
														</tbody>
													</table>
			    ...
			    <h4 id="GenerateReport"> <strong> Custom Report (SMS Monthly Reports - SMS Sending) </strong> </h2>
				<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/monthlysms.png"  style="width:50%;"> </center><br>
	                	   		<ol> 
	                	   			<li> Select Start Date </li>
	                	   			<li> Break down by </li>
	                	   				<p> 
	                	   		...
	                	   		<div class="caption">
			                    	<table class="table table-bordered table-striped">
											...
											<table class="table table-bordered table-striped">
												...
												<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/monthlysms1.png"  style="width:100%;"> </center>
												<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/monthlysms2.png"  style="width:100%;"> </center><br>
													<table class="table table-bordered table-striped">
														<thead>
												            <tr>
												                <th class="col-sm-2"><span>Column</span></th> 
			...
			<h4 id="GenerateReport"> <strong> Custom Report (SMS Monthly Reports - Keywords) </strong> </h2>
				<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/monthlykeywords.png"  style="width:100%;"> </center><br>
	                	   		<ol> 
	                	   			<li> Select Start Date </li>
	                	   			<li> Break down by </li>
	                	   				<p> 
			                    	...
			                    	<table class="table table-bordered table-striped">
											...
											<table class="table table-bordered table-striped">
										        ...
										        <tbody>
										            ...
										            <tr>
										                <td class="col-sm-1"> Average Response Time </td>
										                <td class="col-sm-5">  </td>
										            </tr>

										            <tr>
										                <td class="col-sm-1"> Monthly Average </td>
										                <td class="col-sm-5">  </td>
										            </tr>
			...
			<h4 id="GenerateReport"> <strong> Custom Report (SMS Monthly Reports - Campaigns) </strong> </h2>
				<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/monthlycampaigns.png"  style="width:50%;"> </center><br>
	                	   		<ol> 
	                	   			<li> Select Start Date </li>
	                	   			<li> Break down by </li>
	                	   				<p> 
	                	   		...
	                	   		<div class="caption">
									...
									<table class="table table-bordered table-striped">
								        ...
								        <tbody>
											...
											<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/monthlycampaigns1.png"  style="width:100%;"> </center><br>
	                	   					<table class="table table-bordered table-striped">
												<thead>
										            <tr>
										                <th class="col-sm-2"><span>Column</span></th> 
			...
			<h1 id="ManageAccount"> <strong>  Manage Account </strong> </h1>
			    ...
			    <h4 id="Departments"> <strong>  Manage Departments </strong> </h4>
					<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/managedept.png"  style="width:90%;"> </center><br>
	                	   		<ol>
	                	   			<li> Fill out Department </li>
	                	   			<li> Click Submit </li>
	                	   		</ol>
	                	   		<div class="caption">
			                    	<table class="table table-bordered table-striped">
			    ...
			    <h4 id="DepartmentUsers"> <strong>  Manage Users </strong> </h4>
					<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
			    ...
			    <h4 id="DepartmentAddUsers"> <strong>  Add New User </strong> </h4>
					<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
			    ...
			    <h4 id="Products"> <strong>  Manage Products </strong> </h4>
					<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/manageproducts.png"  style="width:90%;"> </center><br>
	                	   		<ol>
	                	   			<li> Fill out Product </li>
	                	   			<li> Click Submit </li>
	                	   		</ol>
	                	   		<div class="caption">
			                    	<table class="table table-bordered table-striped">
			    ...
			    <h4 id="Keywords"> <strong>  Manage Keywords </strong> </h4>
					<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/managekeywords.png"  style="width:90%;"> </center><br>
	                	   		<ol>
	                	   			<li> Fill out Keyword </li>
	                	   			<li> Click Submit </li>
	                	   		</ol>
	                	   		<div class="caption">
			                    	<table class="table table-bordered table-striped">
			    ...
			    <h4 id="CustomFields"> <strong>  Manage Phonebook Custom Fields </strong> </h4>
					<a type="button" class="btn btn-xs btn-danger" href="<?php echo site_url("sample/page_campaign"); ?>" >Back to Top</a> <br> <br>        	
					<div class="span4">
		                <div class="thumbnail">
		                	<center> <img data-src="holder.js/200x200" class="img-thumbnail" alt="200x200" src="assets/img/managecustomfields.png"  style="width:60%;"> </center><br>
	                	   		<ol>
	                	   			<li> Fill out Custom Field/s </li>
	                	   			<li> Click Save Fields </li>
	                	   		</ol>
	                	   		<div class="caption">
			                    	<table class="table table-bordered table-striped">
												<thead>
										        ...
										        <tbody>
										            <tr>
										                <td class="col-sm-1">Custom Field</td>
										                <td class="col-sm-5"> </td>
										            </tr>
										        </tbody>
											</table>
											...
											<table class="table table-bordered table-striped">
										        ...
										        <tbody>
										            <tr>
										                <td class="col-sm-1"> Save Fields </td>
										                <td class="col-sm-5">  </td>
										            </tr>
												</tbody>
											</table>
